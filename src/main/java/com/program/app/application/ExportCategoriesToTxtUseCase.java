...
import com.program.app.interfaces.service.CategoryWriterService;
...
public class ExportCategoriesToTxtUseCase {
    ...
    private final CategoryWriterService service;

    public ExportCategoriesToTxtUseCase(CategoryWriterService service) {
